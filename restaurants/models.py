...
class Restaurant(TimeStampedModel):
    id = models.AutoField(primary_key=True)
    main_category = models.ForeignKey(MainCategory, null=True, on_delete=models.SET_NULL, verbose_name='메인 카테고리')
    ...
    distance = models.DecimalField(max_digits=5, decimal_places=1, null=True, default=None, verbose_name='거리')
